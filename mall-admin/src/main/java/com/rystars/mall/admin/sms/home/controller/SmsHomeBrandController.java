...
public class SmsHomeBrandController implements IBaseController<SmsHomeBrandService, SmsHomeBrand> {

    private final SmsHomeBrandService smsHomeBrandService;

    @Override
    public SmsHomeBrandService getService() {
        return smsHomeBrandService;
    }
